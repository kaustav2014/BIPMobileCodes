...
public class Item extends IBMDataObject {
	...
	/**
	 * Sets the location of a list item, as well as calls setCreationTime().
	 * @param String itemName
	 */
	public void setSosLoc(String userLoc) {
		setObject(SOSLOC, (userLoc != null) ? userLoc : "");
	}
	
	public String getSosLoc() {
		return (String) getObject(SOSLOC);
	}
